        ...
        <div className="navContainer flex items-center px-4 py-2 shadow">
          ...
          <nav>
            <ul className="mainNav" style={open ? { transform: 'translateX(0)' } : null}>
              ...
              <div className=''>
                ...
                <li className="flex items-center nav-list-item pl-6 border-b-2 pb-2">
                  <svg className='mr-4' width="20" height="20" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16.7143 8.57138C16.7172 9.7027 16.4529 10.8187 15.9428 11.8285C15.3381 13.0386 14.4083 14.0564 13.2578 14.7679C12.1073 15.4794 10.7813 15.8566 9.42856 15.8571C8.29725 15.86 7.18123 15.5957 6.17142 15.0857L1.28571 16.7142L2.91428 11.8285C2.40422 10.8187 2.1399 9.7027 2.14285 8.57138C2.14337 7.2186 2.52052 5.89268 3.23204 4.74214C3.94356 3.5916 4.96135 2.66187 6.17142 2.0571C7.18123 1.54704 8.29725 1.28272 9.42856 1.28567H9.85713C11.6437 1.38423 13.3312 2.13832 14.5964 3.40355C15.8616 4.66877 16.6157 6.35623 16.7143 8.14281V8.57138Z" stroke="#1A202C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
              ...
              {/* LOGOUT BUTTON */}
              <li className="pl-6 pt-6 pb-6 flex justify-center">
