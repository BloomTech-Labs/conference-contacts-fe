          ...
          <svg
            ...
            <div className="flex">
              <ul className="desktop-nav flex items-center">
                <a className="p-6 desktop-link text-lg  bg-transparent hover:bg-blue-500 text-blue-700 hover:text-white  mr-6" href="#features">
                  Features
                </a>
                <a className="px-6 ml-5 solid  p-6 desktop-link text-lg bg-transparent hover:bg-blue-500 text-blue-700 hover:text-white mr-6" href="#demo">
                  Demo
                </a>
                <a className="px-6 ml-5 solid  p-6 desktop-link text-lg bg-transparent hover:bg-blue-500 text-blue-700 hover:text-white mr-6" href="#team">
                  Team
                </a>
                <a className="px-6 ml-5 solid  p-6 desktop-link text-lg bg-transparent hover:bg-blue-500 text-blue-700 hover:text-white" href="#reviews">
                  Reviews
                </a>
              </ul>
            </div>
