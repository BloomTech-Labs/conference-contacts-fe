				...
				<div className="pt-5 desktop:pt-0 flex flex-col overflow-hidden px-6 pb-8">
					...
					<div className="flex flex-col desktop:flex-row-reverse justify-between">
						...
						<div className="flex flex-col pl-0 m-0">
							...
							<section className="mt-10">
								<h2 className="uppercase text-xs text-gray-900 tracking-widest text-2xl">Job Title</h2>
					...
					<div className="desktop:flex desktop:justify-between">
						<div className="">
							{/* location */}
							<section className="mt-10">
								<h2 className="uppercase text-xs text-gray-900 tracking-widest text-2xl">Location</h2>
								<p className="mt-4 text-xl">
							...
							{/* DOB */}
							<section className="mt-10">
								<h2 className="uppercase text-xs text-gray-900 tracking-widest text-2xl">Birthdate</h2>
								<p className="mt-4 text-xl">
							...
							{/* tagline */}
							<section className="mt-10">
								<h2 className="uppercase text-xs text-gray-900 tracking-widest text-2xl">Tagline</h2>
								<p className="mt-4 text-xl">
