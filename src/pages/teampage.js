        ...
        <div className="w-full md:w-1/3 px-2 mb-6">
          <div className="col-12 col-sm-6 col-lg-4">
            <div className="grid-2 container hovereffect">
              ...
              <img
                className="rounded-r-lg rounded-tl-lg ease img-size mx-auto"
                src="https://avatars0.githubusercontent.com/u/5513859?s=400&u=052da10ccf63aee78fa180c37508b858dd63bf8c&v=4"
                alt="Corey"
                border="0"
              ></img>
              <div className="middle flex">
            ...
            <h4 className="text-3xl text-gray-800 font-bold mb-3">Corey Gumbs</h4>
            <p className="text-gray-500 mb-8">Software Engineer</p>
          </div>
        </div>
        <div className="w-full md:w-1/3 px-2 mb-6">
          <div className="col-12 col-sm-6 col-lg-4">
            <div className="grid-2 container hovereffect">
              ...
              <img
                className="rounded-r-lg rounded-tl-lg ease img-size mx-auto"
                src="https://avatars2.githubusercontent.com/u/24205051?s=400&u=d408dd53d0177e38912d88fc92e0f5f978be47dc&v=4"
                alt="Erica"
                border="0"
              ></img>
              <div className="middle flex">
            ...
            <h4 className="text-3xl text-gray-800 font-bold mb-3">Erica Ingram</h4>
            <p className="text-gray-500 mb-8">Software Engineer</p>
          </div>
        </div>
        <div className="w-full md:w-1/3 px-2 mb-6">
          <div className="col-12 col-sm-6 col-lg-4">
            <div className="grid-2 container hovereffect">
              ...
              <img
                className="rounded-r-lg rounded-tl-lg ease img-size mx-auto"
                src="https://avatars2.githubusercontent.com/u/29408647?s=400&u=0d3235b6c77700524e2c5ac60c99049153f8d7f1&v=4"
                alt="Roberto"
                border="0"
              ></img>
              <div className="middle flex">
            ...
            <h4 className="text-3xl text-gray-800 font-bold mb-3">Roberto Banbanaste</h4>
            <p className="text-gray-500 mb-8">Software Engineer</p>
          </div>
        </div>
        <div className="w-full md:w-1/3 px-2 mb-6">
          <div className="col-12 col-sm-6 col-lg-4">
            <div className="grid-2 container hovereffect">
              ...
              <img
                className="rounded-r-lg rounded-tl-lg ease img-size mx-auto"
                src="https://avatars0.githubusercontent.com/u/49458951?s=460&u=324e01b65df650dc68c8d1d4c2e7570fb597eecc&v=4"
                alt="Sierra"
                border="0"
              ></img>
              <div className="middle flex">
            ...
            <h4 className="text-3xl text-gray-800 font-bold mb-3">Sierra Curtis</h4>
            <p className="text-gray-500 mb-8">Software Engineer</p>
          </div>
        </div>
        <div className="w-full md:w-1/3 px-2 mb-6">
          <div className="col-12 col-sm-6 col-lg-4">
            <div className="grid-2 container hovereffect">
              ...
              <img
                className="rounded-r-lg rounded-tl-lg ease img-size mx-auto"
                src="https://avatars2.githubusercontent.com/u/57115535?s=460&v=4"
                alt="Tristan"
                border="0"
              ></img>
              <div className="middle flex">
            ...
            <h4 className="text-3xl text-gray-800 font-bold mb-3">Tristan Depew</h4>
            <p className="text-gray-500 mb-8">Software Engineer</p>
          </div>
        </div>
        <div className="w-full md:w-1/3 px-2 mb-4">
        ...
        <div className="w-full md:w-1/3 px-2 mb-6">
          <div className="col-12 col-sm-6 col-lg-4">
            <div className="grid-2 container hovereffect">
              ...
              <img
                className="rounded-r-lg rounded-tl-lg ease img-size mx-auto"
                src="https://i.ibb.co/LJxP6s2/16213161.jpg"
                alt="Chad"
                border="0"
              ></img>
              <div className="middle flex">
            ...
            <h4 className="text-3xl text-gray-800 font-bold mb-3">Chad Rutherford</h4>
            <p className="text-gray-500 mb-8">IOS Developer</p>
          </div>
        </div>
        <div className="w-full md:w-1/3 px-2 mb-4">
