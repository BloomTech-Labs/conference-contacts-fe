                ...
                <div className='pt-32 pb-32 bg-gray-200'>
                    ...
                    <div className=''>
                        ...
                        <div className="mb-6 w-2/3 m-auto">
                            ...
                            <input ref={node => { input = node }} className="shadow-md appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="preferred" type="text" placeholder="Preferred form of contact" />
                        </div>
                        <div className="mb-6 w-2/3 m-auto">
                            <label className="block text-gray-700 text-sm font-bold mb-2" for="socialmedia">
                                Social Media
                            </label>
                            <input ref={node => { input = node }} className="shadow-md appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="socialmedia" type="text" placeholder="Social Media" />
                        </div>
                        <div className="mb-6 w-2/3 m-auto">
                            <label className="block text-gray-700 text-sm font-bold mb-2" for="image">
                                Image
                            </label>
                            <input ref={node => { input = node }} className="shadow-md appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-white" ref={(ref) => upload = ref} id="image" type="file" name="pic" accept="image/*" placeholder="Upload Image" />
                        </div>
