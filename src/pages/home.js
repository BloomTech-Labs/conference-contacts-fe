		...
		<div className="pt-24 pb-6 bg-gray-200 smcustom:pt-24 mdcustom:pt-32">
            ...
            <div className="text-lg">
              {data.user.connections.length === 1 ? (
				...
				{qrCode && (
					// fgColor changes foreground color of qrcode
					// bgColor changes background color of qrcode
					<div className="flex justify-center my-6">
						<span className="qr-box p-4">
							<QRC includeMargin={false} level="Q" renderAs="svg" value={qrLink} fgColor="#6640FF" />
						</span>
					</div>
				)}
					...
					<div className="relative flex-grow-0">
						...
						{notificationCount > 0 && (
							<div className="absolute top-0 right-0 -mt-3 -mr-3 bg-purple-700 text-white w-6 h-6 text-xs rounded-full leading-none flex items-center justify-center">
								{notificationCount >= 1000 ? notificationCount.toString()[0] + 'k' : notificationCount}
							</div>
						)}
					</div>
